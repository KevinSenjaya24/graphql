    ...
    <div class="panel panel-info">
        <div class="panel-wrapper collapse in" aria-expanded="true">
            <div class="panel-body">
                <h3 class="box-title m-b-0 black">Table Tribun</h3>
                <hr>
                <div class="table-responsive">
                    <table id="myTable" class="table table-striped" >
                        ...
                        <tbody>
                        @foreach($tribuns->channel->item as $tribun) 
                            <tr>
                                <td>{{$tribun->title}}</td>
                                <td><a href="{{$tribun->link}}">{{$tribun->link}}</a></td>
                                <td>{!! $tribun->description !!}</td>
                                <td>{{$tribun->pubDate}}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
